...
### 2. 更新前端檔案 (`GlobalMarketDashboard.jsx`)
這裡只要更新最上方的 `INITIAL_MARKET_DATA` 常數即可（也就是前 20 行左右的範圍）。我已經幫您將「台指期 (電子盤)」放進去了，請將這段覆蓋原本對應的區塊：

```react:全球股市即時監控面板:GlobalMarketDashboard.jsx (局部更新)
